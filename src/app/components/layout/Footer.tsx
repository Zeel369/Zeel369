...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#0a1929] to-[#1a2f45] text-white">
      <div className="max-w-[1200px] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Logo and Description */}
          <div className="lg:col-span-1">
            <div className="text-2xl font-bold mb-4">MTSAI</div>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Solving traffic congestion with trust, technology, and voter support.
              A ready-to-deploy, self-financing solution for modern cities.
            </p>

            {/* App Store Badges */}
            <div className="flex flex-col space-y-3">
              <a href="#" className="inline-block">
                <div className="bg-white text-black px-4 py-2 rounded-lg text-xs font-medium hover:bg-gray-100 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/technology" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Technology
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/evidence-standard" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Evidence Standard
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} MTSAI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
